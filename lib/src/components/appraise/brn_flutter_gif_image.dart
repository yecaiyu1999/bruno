...
class GifImageState extends State<GifImage> {
  ...
  Future<void> fetchGif(ImageProvider provider) async {
    ...
    if (provider is AssetImage) {
      ...
      ui.Codec codec = await usePaintingBinding().instantiateImageCodecWithSize(
        await ImmutableBuffer.fromUint8List(data.buffer.asUint8List()), // 修改，默认data.buffer.asUint8List()
      );
